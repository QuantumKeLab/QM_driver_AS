...
ro_infos = [
    ...
    {
        "name":"q3",
        "IF": -42+0.83+5-2-0.96-10+0.9-1.6-1.74+1.78+0.27-0.35-1.39+0.83-0.49+1.21-1.04,
        "amp": 0.2*0.846*0.75*0.75*0.68,#*0.3*0.5 *0.8,
        "length":400,
        "phase": 156.1+269.6+2.8+344.8+234.9-6.3+137.9+274.4+59.9+330.2
    },
    # {
    #     "name":"q3",
    ...
    {
        "name":"q4",
        "IF":-128+0.68+5+1.6-2.4-7.5+1.28-3.79-0.6-2.738+0.66+2.32+0.59-0.73-0.99-1+1.36-2+0.44+3.44-2.5,
        "amp": 0.2*0.667*0.782*0.19*2*2*0.75*0.5*1.5,
        "length":400,
        "phase": 229.9+34+0.1+33.6+318.7+293.7+73.9+220.5+221.3+3.7+307.6+26.7+356.3+108.8
    },
    {
        "name":"q5",
        "IF": -62+1.36+2.8-1.17-10.31+0.7+0.05-1.52,
